		...
		<div class="col-sm-7" id="colLibros">
			<div class="libros">
				<?php
						...
						$consultaCant="SELECT idLibro FROM libro";
						$resultadoCant=mysqli_query($conn,$consultaCant);
						$cantidadTotalLibros=mysqli_num_rows($resultadoCant);
						$consultaCant="SELECT * FROM libro ORDER BY RAND() LIMIT 10";
						...
						while ($array = mysqli_fetch_assoc($resultadoL)){
							...
							//Datos de Libro
							$LTitulo="$array[titulo]";
							$LAnio="$array[anio]";
							$LISipnosis="$array[sipnosis]";
							$LFoto="$array[foto]";
							$LCalificacion="$array[calificacion]";
